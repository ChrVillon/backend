...
SECRET_KEY = 'django-insecure-_)fj8(2s122du0+haq3ky(0vt7q17l(k79qrqx2*qxs2!jj_p5'
...
FIREBASE_CRED = credentials.Certificate("keys/tallerlading-firebase-adminsdk-lfskk-97386a49c4.json")

# Inicialice la conexión con el Realtime Database con la clave privada y la URL de referencia
firebase_admin.initialize_app(FIREBASE_CRED, {
    'databaseURL': 'https://tallerlading-default-rtdb.firebaseio.com'
})